		...
		<div class="col-md-6">
			<div class="box no-padding">
				...
				<div class="box-header">
					...
					?>
					<h2 class="box-title pull-left">Total Students (<?php echo $count; ?>)</h2>
				...
				<div class="box-body">
					<table class="table table-responsive table-striped">
						<thead>
							<tr>
								<th>#</th>
								<th style="min-width:100px">ROLL</th>
					...
					<?php } ?>
						...
						<tbody>
							...
							<tr>
								...
								<td><input required="required" type="text"   class="tc form-control" name="tc[]"></td>
								<td><input required="required" type="text"  class="tf form-control" name="tf[]"></td>
								<td><input required="required" type="text"  class="pc form-control" name="pc[]"></td>
								<td><input required="required" type="text"  class="pf form-control" name="pf[]"></td>
							</tr>
							<?php
								$i++;
									}
