	...
	$sql = "SELECT studentinformation.id,studentinformation.roll,studentinformation.registrationNo,studentinformation.name,studentinformation.fatherName, studentinformation.motherName,studentinformation.irregular,session.session,technology.technologyName,semester.semester,studentinformation.shift from studentinformation INNER JOIN session on session.sessionId=studentinformation.sessionId INNER JOIN technology on technology.technologyId=studentinformation.technologyId INNER JOIN semester on semester.semesterId=studentinformation.semesterId ORDER BY studentinformation.roll";
