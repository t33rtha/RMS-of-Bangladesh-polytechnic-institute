...
.technologyId and
 ...
 .semesterId=$semester and SI.irregular=1 and SI.shift=$shift and SC.subjectId=$subject and SI.roll IN(SELECT `$subjectCode[0]`.roll from `$subjectCode[0]`) group by  `$subjectCode[0]`.roll";
