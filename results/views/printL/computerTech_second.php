	...
	<section class="invoice">
      ...
      <label>Dhaka</label>                   
        ...
        <div class="row no-print">
          <div class="col-xs-12">
            <a href="../print/mechatronicsTech_second.php?roll=<?php echo $rowMark['roll'];?>" target="_blank" class="btn btn-success pull-right"><i class="fa fa-print"></i> P r i n t</a>          
          </div>
        </div>
  </section>
