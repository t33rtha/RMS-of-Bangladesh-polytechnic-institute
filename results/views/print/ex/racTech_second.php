...
require_once('../../controllers/class.marksheet.php');
	...
	$markSQL="SELECT si.id,si.roll,si.registrationNo,si.name,si.motherName,si.fatherName,t.technologyCode,t.technologyName,s.session,si.shift,sem.semester,
				red.pc as red_pc,red.pf as red_pf,
			...
			from studentinformation si 
				...
				LEFT JOIN `67221` red on red.roll=si.roll 
          ...
          <table class="table text-center table-bordered table-striped">
            ...
            <tbody>
	            <tr>
	            	<td>1</td>
	            	<td>67221</td>
	            	<td>Refrigereation Engineering Drawing</td>
	            	<td>100</td>
	            	<td>
	            		<?php 

	            				if($rowMark['red_pc']<10 || $rowMark['red_pf']<10){
	            					$m_o=0;
	            				}else{
	            					$m_o=(($rowMark['red_pc']+$rowMark['red_pf']));
	            				}
