...
var table = $('#example').DataTable({
       ...
       'columnDefs': [{
         ...
         'render': function (data, type, full, meta){
             return '<input class="student"  type="checkbox" name="id[]" value="'+ data +'">';
         }
      }]
    });
     ...
     $('<button id="downgrateBtn" class="btn btn-danger">Downgrate</button>&nbsp;<button id="migrateBtn" class="btn btn-success">Migrate</button>').insertAfter('div.dataTables_length');
