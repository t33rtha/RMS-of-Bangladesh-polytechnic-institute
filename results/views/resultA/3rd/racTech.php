	...
	<section class="invoice">
	            	...
	            	<td>
	            		<?php 
	            			if($rowMark['rcc_tc']<24 || $rowMark['rcc_tf']<36|| $rowMark['rcc_pc']<10 || $rowMark['rcc_pf']<10){
	            				...
	            				$m_o=(($rowMark['rcc_tc'])+($rowMark['rcc_tf'])+($rowMark['rcc_pc'])+($rowMark['rcc_pf']));
	            			}	            				
	            			echo $m_o;
	            		...
	            		<b>
	            			<?php 
	            				if(in_array('0.00',$cgpa)){
	            					...
	            					$gpa=round((array_sum($grandCgpa)/18),2);
	            					echo $gpa;
      ...
      <label>Thakurgaon</label>                   
        ...
        <div class="row no-print">
          <div class="col-xs-12">
            <a href="../print/racTech_third.php?roll=<?php echo $rowMark['roll'];?>" target="_blank" class="btn btn-success pull-right"><i class="fa fa-print"></i> P r i n t</a>          
          </div>
        </div>
  </section>
